...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String attachmentCount(int count) {
    return '$count 個の添付ファイル';
  }

  @override
  String get cancelGeneration => '生成をキャンセル';

  @override
  String get createChatRoom => 'チャットルームを作成';

  @override
  String attachmentUploadFailed(String error) {
    return '添付ファイルのアップロードに失敗しました: $error';
  }
  ...
  @override
  String get showDetectionResults => '検知結果を表示';
